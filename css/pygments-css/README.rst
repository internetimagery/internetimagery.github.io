...
I'm using a combination of Pygments and Markdown on a django project that has a model with the following save method::
    ...
    def save(self):
        self.html = markdown(self.body, pre')
        super(Entry, self).save()

That's why the CSS styles all have pre in front of them. You should change the pre to work with the style name that you use for your Pygments HTML output.
